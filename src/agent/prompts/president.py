...
9. **⚠️ 同盟国の集団防衛義務（最重要判断事項）**: 自国が同盟関係（alliance）にある国が第三国から攻撃（at_war）を受けている場合、以下を必ず thought_process に記載して最終判断してください：
   ...
   - **共同防衛の使い方**: `join_ally_defense: true` + `defense_support_commitment: 0.01〜0.50` を攻撃国向けのdiplomatic_policyに設定。自国軍の一部が防衛側の戦争に合流し、防衛側の戦力が増強される。同盟関係がなくても参加可能（有志連合型）。declare_warとは異なり、新たな二国間戦争は発生しない。
"""
