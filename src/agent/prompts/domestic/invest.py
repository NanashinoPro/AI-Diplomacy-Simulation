...
貿易収支NX={country_state.last_turn_nx:+.1f} / 対GDP債務比={debt_ratio:.0f}%
...
【💰 現在の歳入: {budget:.1f} B$】
【ルール】request_education（B$単位）: HCIを蓄積し中長期的なGDP成長バフを生む教育・科学支出額。
